  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="order_admin.php" class="nav-link">View Customer Orders</a></li>
             <li class="nav-item active"><a href="order_queue.php" class="nav-link">View Orders</a></li>
      ...
      <div id="work-collections" class="seaction">
          ...
          <?php
           ...
           $sql = mysqli_query($conn, "SELECT * FROM orders ORDER BY date ASC");
