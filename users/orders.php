...
<head>   <title>Order List</title>
  ...
  <!-- CORE CSS-->
  <link href="css/materialize.min.css?version=51" type="text/css" rel="stylesheet" media="screen,projection">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="orders.php" class="nav-link">View Orders</a></li>
        ...
        <div class="container">
          <!--editableTable-->
			<div id="work-collections" class="seaction">
					...
					$sql = mysqli_query($conn, "SELECT * FROM orders WHERE customer_id = $user_id ORDER BY date DESC;");
					echo '              <div class="row">
                <div class="col-md-12">
            ...
            $sql_customer = mysqli_query($conn, "SELECT * FROM users WHERE user_id= '$user_id'");
